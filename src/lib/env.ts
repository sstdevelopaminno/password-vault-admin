...
const schema = z.object({
  ...
  NEXT_PUBLIC_ADMIN_QR_SESSION_TIMEOUT_SECONDS: z.coerce.number().int().min(30).max(600).default(120),
...
export function getEnv(): ParsedEnv {
  ...
  const runtimeEnv = {
    ...
    NEXT_PUBLIC_ADMIN_QR_SESSION_TIMEOUT_SECONDS: process.env.NEXT_PUBLIC_ADMIN_QR_SESSION_TIMEOUT_SECONDS,
